...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/changer-assurance-emprunteur/vos-droits/loi-lemoine" },
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
      ...
      <section className="prose-madeleg space-y-4 mb-12" style={{ color: "var(--text-body)" }}>
        ...
        <p>
          ...
          <Link href="/changer-assurance-emprunteur/vos-droits/apres-plusieurs-annees" className="underline">
        ...
        <p>
          ...
          <Link href="/changer-assurance-emprunteur/vos-droits/resilier" className="underline">
