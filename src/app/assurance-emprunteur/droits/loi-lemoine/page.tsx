...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/assurance-emprunteur/droits/loi-lemoine" },
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
      ...
      <section className="prose-madeleg space-y-4 mb-12" style={{ color: "var(--text-body)" }}>
        ...
        <p>
          ...
          <Link href="/assurance-emprunteur/droits/apres-plusieurs-annees" className="underline">
        ...
        <p>
          ...
          <Link href="/assurance-emprunteur/droits/comparer" className="underline">
        ...
        <p>
          ...
          <Link href="/assurance-emprunteur/sante/questionnaire-sante" className="underline">
        ...
        <p>
          ...
          <Link href="/assurance-emprunteur/droits/resilier" className="underline">
