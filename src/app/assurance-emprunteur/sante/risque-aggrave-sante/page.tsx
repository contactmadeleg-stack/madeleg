...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/assurance-emprunteur/sante/risque-aggrave-sante" },
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
      ...
      <section className="prose-madeleg space-y-4 mb-12" style={{ color: "var(--text-body)" }}>
        ...
        <p>
          ...
          <Link href="/assurance-emprunteur/sante/maladies-cardiovasculaires" className="underline">
