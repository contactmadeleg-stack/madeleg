...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/risque-aggrave-sante/pathologies/maladies-cardiovasculaires" },
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
      ...
      <section className="prose-madeleg space-y-4 mb-12" style={{ color: "var(--text-body)" }}>
        ...
        <p>
          ...
          <Link href="/risque-aggrave-sante/pathologies/vih" className="underline">
            VIH
          </Link>{" "}
          ou le{" "}
          <Link href="/risque-aggrave-sante/pathologies/diabete" className="underline">
            diabète
          </Link>
          .
        </p>
