...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/profil-emprunteur/situation-professionnelle/fonctionnaire" },
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:py-20">
      ...
      <section className="prose-madeleg space-y-4 mb-12" style={{ color: "var(--text-body)" }}>
        ...
        <p>
          La procédure est identique à celle de tout emprunteur, grâce à la{" "}
          <Link href="/changer-assurance-emprunteur/vos-droits/loi-lemoine" className="underline">
            loi Lemoine
          </Link>{" "}
          : résiliation possible à tout moment, sans frais ni justification, à condition que le nouveau contrat offre des garanties équivalentes. Un
